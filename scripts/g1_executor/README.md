...
Minimal step-1 movement executor scaffold.

## Files

- `motion_executor.py`: core closed-loop motion executor demo.
- `dispatcher_templates.py`: command templates for dispatchers/controllers.
